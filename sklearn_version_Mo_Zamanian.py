...
plt.savefig('sklearn--img-1.png', dpi=300)
plt.grid(True)
plt.savefig('sklearn--img-1-grid.png', dpi=300)
plt.show()
...
plt.savefig('sklearn--img-2.png', dpi=300)
plt.grid(True)
plt.savefig('sklearn--img-2-grid.png', dpi=300)
plt.show()
